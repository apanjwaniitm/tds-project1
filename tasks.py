...
def format_markdown():
    ...
    try:
        subprocess.run(["npx", "prettier@3.4.2", "--write", "C:\Users\aakan\tds-project1\tds-project1\data\format.md"], check=True)
...
def count_wednesdays():
    ...
    with open("C:\Users\aakan\tds-project1\tds-project1\data\dates.txt", "r") as f:
        dates = f.readlines()
...
def sort_contacts():
    ...
    with open("C:\Users\aakan\tds-project1\tds-project1\data\contacts.json", "r") as f:
...
def extract_recent_logs():
    ...
    log_dir = "C:\Users\aakan\tds-project1\tds-project1\data\logs\"
    log_files = sorted(
...
def index_markdown_titles():
    ...
    index = {}
    docs_dir = "C:\Users\aakan\tds-project1\tds-project1\data\docs\"
...
def extract_email_sender():
    ...
    with open("C:\Users\aakan\tds-project1\tds-project1\data\email.txt", "r") as f:
...
def extract_credit_card():
    ...
    image = Image.open("C:\Users\aakan\tds-project1\tds-project1\data\credit_card.png")
...
def find_similar_comments():
    ...
    with open("C:\Users\aakan\tds-project1\tds-project1\data\comments.txt", "r") as f:
...
def compute_gold_sales():
    ...
    conn = sqlite3.connect("C:\Users\aakan\tds-project1\tds-project1\data\ticket-sales.db")
    cursor = conn.cursor()
